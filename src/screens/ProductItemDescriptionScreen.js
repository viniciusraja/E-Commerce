    ...
    <View style={styles.container}>
      ...
      <View style={styles.detailsContainer}>
        ...
        <SharedElement
          ...
          >
          <Text style={styles.priceTagText}>{`R$${data.price}`}</Text>
        </SharedElement>
          </View>
        <View
          style={{
          ...
          <StyledBars
            innerColor={Constants.Colors.yellowMostard}
          ...
          <SharedElement
            ...
            <Text style={styles.burguerDetailText}>
              {data.details.ingredientsDetails}
            </Text>
            <Text style={styles.burguerNutritionalDetailText}>
              {data.details.allergicInformation}
            </Text>
          </View>
          <StyledBars
            innerColor={Constants.Colors.yellowMostard}
        ...
        <View style={styles.productsFooterContainer}>
          ...
          <View style={styles.addToCartContainer}>
            ...
            <MaterialIcons name="attach-money" size={26} color={Constants.Colors.yellowMostard} />
            </View>
      ...
      <SharedElement
        ...
        <Image
          ...
          source={images.products[data.img]}
          resizeMode="contain"
        />
      </SharedElement>
      <LoginContainer />
...
ProductItemDescriptionScreen.sharedElements = (
  ...
  console.log(otherNavigation.state.routeName,'aaaaa',showing)
